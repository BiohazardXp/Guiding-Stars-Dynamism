...
function Sidebar() {
  ...
  const handleLogout = () => {
    ...
    // Update auth context if it has a logout method
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside
        className={`fixed left-0 top-0 h-screen w-64 bg-gray-800 text-white shadow-lg flex flex-col z-40 transition-transform duration-300 ${
